...
- [Requisitos do projeto](#requisitos-do-projeto)
    ...
    - [2 - Ordene a coleção `produtos` pela quantidade de lanches vendidos em ordem crescente.](#2---ordene-a-coleção-produtos-pela-quantidade-de-lanches-vendidos-em-ordem-crescente)
    - [3 - Retorne o lanche mais vendido.](#3---retorne-o-lanche-mais-vendido)
    - [4 - Retorne os lanches que tiveram vendas maiores que `50` e menores que `100`.](#4---retorne-os-lanches-que-tiveram-vendas-maiores-que-50-e-menores-que-100)
    - [5 - Retorne os lanches que tiveram quantidade de `curtidas` igual a `36` ou tenham a quantidade de vendas igual a `85`.](#5---retorne-os-lanches-que-tiveram-quantidade-de-curtidas-igual-a-36-ou-tenham-a-quantidade-de-vendas-igual-a-85)
    - [6 - Retorne todas as informações do lanche `Big Mac` e não mostre seus `valoresNutricionais`.](#6---retorne-todas-as-informações-do-lanche-big-mac-e-não-mostre-seus-valoresnutricionais)
    - [7 - Retorne os lanches que tenham sido `vendidos` com quantidade maior que `90`.](#7---retorne-os-lanches-que-tenham-sido-vendidos-com-quantidade-maior-que-90)
    - [8 - Delete os lanches que tenham menos de `50` `curtidas`.](#8---delete-os-lanches-que-tenham-menos-de-50-curtidas)
    - [9 - Retorne todos os lanches que possuam `calorias` abaixo de `500`.](#9---retorne-todos-os-lanches-que-possuam-calorias-abaixo-de-500)
    ...
    - [29 - Conte quantos documentos contêm as palavras `frango` ou `hamburguer` utilizando o operador `$text`.](#29---conte-quantos-documentos-contêm-as-palavras-frango-ou-hamburguer-utilizando-o-operador-text)
    - [30 - Conte quantos documentos contêm a **expressão** `feito com` utilizando o operador `$text`.](#30---conte-quantos-documentos-contêm-a-expressão-feito-com-utilizando-o-operador-text)
    - [31 - Renomeie o campo `descricao` para `descricaoSite` em todos os documentos.](#31---renomeie-o-campo-descricao-para-descricaosite-em-todos-os-documentos)
    - [32 - Remova o campo `curtidas` do item `Big Mac`.](#32---remova-o-campo-curtidas-do-item-big-mac)
    - [33 - Retorne o `nome` dos sanduíches em que o número de `curtidas` é maior que o número de sanduíches `vendidos`.](#33---retorne-o-nome-dos-sanduíches-em-que-o-número-de-curtidas-é-maior-que-o-número-de-sanduíches-vendidos)
    - [34 - Retorne o `nome` e a quantidade de vendas (`vendidos`) dos sanduíches em que o número de vendas é múltiplo de `5`.](#34---retorne-o-nome-e-a-quantidade-de-vendas-vendidos-dos-sanduíches-em-que-o-número-de-vendas-é-múltiplo-de-5)
...
1. Conte quantos produtos existem e crie uma query que insira na coleção "resumoProdutos" um documento com o campo: "franquia":"McDonald's" e "totalProdutos" (o total retornado anteriormente)
